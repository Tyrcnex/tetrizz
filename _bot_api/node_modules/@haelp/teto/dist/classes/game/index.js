   ...
   */ stop() {
    ...
    start() {
        this.pipe({
            ...
            frame: 0,
            data: {}
        }, (0, _utils.getFullFrame)(this.options));
    ...
    async tickGame() {
        ...
        try {
            ...
            if (target <= -2000 && !this.#slowTickWarning) {
                console.log(`${_chalk.default.red("[Triangle.js]")} Triangle.js is lagging behind by more than 2 seconds! Your \`tick\` function is likely taking too long to execute.`);
