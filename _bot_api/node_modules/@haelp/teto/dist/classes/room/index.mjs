...
import { roomConfigPresets } from "./presets.mjs";
import { ReplayManager } from "./replayManager.mjs";
export class Room {
    client;
    listeners = [];
    ...
    init() {
        ...
        this.listen("game.end", (data)=>{
            ...
            const maxWins = data.scoreboard.reduce((max, item)=>Math.max(max, item.wins), 0);
...
export { ReplayManager } from "./replayManager.mjs";
