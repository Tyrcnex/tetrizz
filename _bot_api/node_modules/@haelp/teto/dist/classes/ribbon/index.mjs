import { API, docLink, EventEmitter } from "../../utils/index.mjs";
import { CandorCodec } from "./codecs/codec-candor.mjs";
import { tetoPack } from "./codecs/teto-pack.mjs";
import { Bits } from "./codecs/utils/bits.mjs";
...
export class Ribbon {
    ...
    async #connect() {
        if (typeof WebSocket === "undefined" || !WebSocket) {
            throw new Error(`Native WebSocket not found. See ${docLink("native-websocket-not-found")} for more information.`);
        }
