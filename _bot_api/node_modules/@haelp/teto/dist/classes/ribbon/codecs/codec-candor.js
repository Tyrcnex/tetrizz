...
Object.defineProperty(exports, "CandorCodec", {
    enumerable: true,
    get: function() {
        return Le;
    }
});
const _bits = require("./utils/bits");
const _msgpackr943ed70 = /*#__PURE__*/ _interop_require_default(require("./utils/msgpackr-943ed70"));
const _shared = require("./utils/shared");
const _fastequals = require("fast-equals");
...
function initOptions() {
    let OptionsTemplate = {};
    for (const [e, t] of Object.entries(_shared.OptionsList)){
...
const ke = new _msgpackr943ed70.default.Packr(ve);
const we = new _msgpackr943ed70.default.Unpackr(ve);
const Be = {
    F_ALLOC: 1,
    F_HOOK: 2,
    F_ID: 128
...
const Le = new class {
    ...
    Decode(e) {
        ...
        let r = 1;
        if (!s) {
            throw new ReferenceError(`received an unknown code [0x${i.toString(16).padStart(2, "0")}]`);
        }
        if (s.flags & this.FLAG.F_ALLOC) {
            return o;
        }
...
class Oe extends De {
    static AddStructure(e) {
        ...
        for (const [t, { mode: n, type: c, size: h, value: u }] of Object.entries(e)){
            switch(n){
                case "static":
...
class We extends De {
    ...
    encode(e) {
        ...
        for (const { gameid: n, board: { b: i, f: s, g: o, w: r, h: a } } of this.boards){
            e.writeUInt(n, 13);
            e.writeUInt(s, 10);
...
class He extends De {
    ...
    encode(e) {
        ...
        for (const { gameid: n, stats: i, allies: s, specCount: o, speedrun: r, nearWR: a, talentless: l } of this.sb){
            e.writeUInt(n, 13);
    ...
    encode(e) {
        ...
        switch(this.type){
            ...
            case "manual_target":
                ...
                return e.finalize();
            default:
                console.warn(`Fallback to packer ${this.type} -> ${JSON.stringify(this.data)}`);
                e.pack(this.data);
                return e.finalize();
        }
    }
...
class Ne extends De {
    ...
    encode(e) {
        ...
        for (const { gameid: t, userid: n, alive: i, naturalorder: s, options: o } of this.players){
            e.writeHex(n, 12);
            e.writeUInt(t, 13);
            e.writeBoolean(i);
            e.writeUInt(s, 13);
...
class $e extends De {
    static init() {
        super.AddTable("piece", [
            null,
            ...Object.keys(_shared.tetrominoes)
        ], "flexible");
        super.AddTable("ixs", [
            "off",
            "hold",
...
class Je extends De {
    static init() {
        ...
        super.AddTable("spinbonus", [
            ...Object.keys(_shared.spinbonuses_rules)
        ], "flexible");
        super.AddTable("colors", [
            ..._shared.minocolors
        ]);
        super.AddTable("kicksets", [
            ...Object.keys(_shared.kicksets)
        ], "flexible");
        super.AddTable("special", [
            "i",
            "i2",
            "i3",
            "l3",
...
class et extends De {
    ...
    static OptsBook = _shared.OptionsList;
    static init() {
        super.AddTable("options", Object.keys(this.OptsBook));
        super.AddTable("minoskin", [
            "i",
            "j",
            "l",
            "o",
        ...
        for (const [n, i, s] of this.ParseOptions(t)){
            ...
            switch(s.type){
                ...
                case "string":
                    ...
                    break;
                default:
                    throw new TypeError(`Unknown type for key: ${n} value: ${i} | got -> ${s.type}`);
            }
        }
        ...
        for(let r = e.peek(t); r !== 0; r = e.peek(t)){
            ...
            switch(r){
                ...
                default:
                    ...
                    throw new TypeError(`Unknown type for key: ${t} | got -> ${r}\nLast Key: ${s}\nLast Value: ${o}\n`);
            }
            s = t;
            o = i[t];
        }
...
class tt extends et {
    static *ParseOptions(e) {
        for (const [n, i, s] of super.ParseOptions(e)){
            if (s.default !== i) {
                if (s.type !== "object" || !(0, _fastequals.strictShallowEqual)(s.default, i)) {
                    yield [
                        n,
                        i,
                        s
...
et.init();
nt.init();
De.LoadExtensions(_msgpackr943ed70.default);
Le.SetMsgpackr(ke, we);

//# sourceMappingURL=codec-candor.js.map