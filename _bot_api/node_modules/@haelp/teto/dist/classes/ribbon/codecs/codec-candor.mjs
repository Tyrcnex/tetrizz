// @ts-nocheck
import { Bits as n } from "./utils/bits.mjs";
import r from "./utils/msgpackr-943ed70.mjs";
import { OptionsList, spinbonuses_rules, kicksets, tetrominoes, minocolors } from "./utils/shared.mjs";
