...
export class Social {
    ...
    /** @hideconstructor */ constructor(client, config, init){
        ...
        this.friends = init.friends.map((r)=>new Relationship({
                id: r.user.id,
                relationshipID: r._id,
                username: r.user.username,
                avatar: r.user.avatar
            }, this, this.client));
        this.other = init.other.map((r)=>new Relationship({
                id: r.user.id,
                relationshipID: r._id,
                username: r.user.username,
                avatar: r.user.avatar
    ...
    init() {
        ...
        this.client.on("social.notification", async (n)=>{
            ...
            if (n.type === "friend") {
                ...
                if (!user) {
                    this.other.push(new Relationship({
                        id: rel.user.id,
   ...
   */ async friend(userID) {
        ...
        this.friends.push(new Relationship({
            id: userData._id,
            relationshipID: "",
