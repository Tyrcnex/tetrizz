...
class Social {
    ...
    init() {
        setTimeout(()=>this.notifications.forEach((n)=>{
                if (n.type === "friend") {
                    if (!n.seen) {
   ...
   */ dm(userID, message) {
        const res = this.client.wrap("social.dm", {
            recipient: userID,
            msg: message
        }, "social.dm", [
            "social.dm.fail",
