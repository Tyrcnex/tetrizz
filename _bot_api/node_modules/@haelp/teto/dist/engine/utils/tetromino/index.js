...
Object.defineProperty(exports, "Tetromino", {
    enumerable: true,
    get: function() {
        return Tetromino;
    }
...
const _ = require("..");
const _kicks = require("../kicks");
const _data = _export_star(require("./data"), exports);
...
class Tetromino {
    ...
    constructor(options){
        ...
        const tetromino = _data.tetrominoes[this.symbol.toLowerCase()];
    ...
    isStupidSpinPosition(board) {
        return !(0, _kicks.legal)(this.blocks.map((block)=>[
                block[0] + this.location[0],
                -block[1] + this.y - 1
            ]), board);
    }
    isAllSpinPosition(board) {
        return !(0, _kicks.legal)(this.blocks.map((block)=>[
                ...
                -block[1] + this.y
            ]), board) && !(0, _kicks.legal)(this.blocks.map((block)=>[
                block[0] + this.location[0] + 1,
                -block[1] + this.y
            ]), board) && !(0, _kicks.legal)(this.blocks.map((block)=>[
                block[0] + this.location[0],
    ...
    rotate(board, kickTable, amt, maxMovement) {
        ...
        const kickRes = (0, _kicks.performKick)(kickTable, this.symbol, this.location, [
            this.aox,
            this.aoy
    ...
    moveRight(board) {
        if ((0, _kicks.legal)(this.blocks.map((block)=>[
                block[0] + this.location[0] + 1,
                -block[1] + this.y
            ]), board)) {
            this.location[0]++;
    ...
    softDrop(board) {
        ...
        while((0, _kicks.legal)(this.blocks.map((block)=>[
                block[0] + this.location[0],
                -block[1] + this.y - 1
            ]), board)){
            this.location[1]--;
    ...
    snapshot() {
        return {
            ...
            location: (0, _.deepCopy)(this.location),
